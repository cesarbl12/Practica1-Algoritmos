...
public class SolitaireGame {
    ...
    public boolean moveTableauToTableau(int tableauFuente, int tableauDestino) {
        ...
        if (!fuente.isEmpty()) {
            ...
            if (cartaInicial != null && destino.sePuedeAgregarCarta(cartaInicial)) {
                ...
                // === Detectar la carta que QUEDARÁ arriba en la fuente tras quitar el bloque ===
                // Será la carta inmediatamente anterior a 'cartaInicial' en la columna.
                ...
                if (idx > 0) {
                    ...
                    // Si estaba boca abajo, el movimiento la destapará; debemos recordarlo para el Undo.
                ...
                if (destino.agregarBloqueDeCartas(bloque)) {
                    ...
                    // Registrar movimiento, indicando qué carta se destapó en la fuente (si hubo)
    ...
    public boolean moveTableauToFoundation(int numero) {
        ...
        // === Detectar si se va a destapar la carta de abajo (segunda desde arriba antes de quitar la última) ===
        CartaInglesa flippedAtSourceTop = null;
        List<CartaInglesa> srcCardsBefore = fuente.getCards();
        ...
        if (carta != null && moveCartaToFoundation(carta)) {
            ...
            // Si la carta de abajo se destapó por remover, hay que volverla a tapar:
